...
<form method="POST" action="{!! url('admin/products/add') !!}" enctype="multipart/form-data">
	...
	<div class="form-group " style="padding-bottom: 45px">
		...
		<div class="col-sm-10">
		  <input value="{!! old('txtTen') !!}" type="text" onkeyup="ChangeToSlug('txtTen','txtAlias')" class="form-control" name="txtTen" id="txtTen" placeholder="Nhập tên sản phẩm" >
		</div>
	</div>
	...
	<div class="form-group col-sm-12" >
		<div class="panel panel-default">
		  <div class="panel-heading">
			<h3 class="panel-title"> Thêm tùy chọn khác</h3>
		  </div>
