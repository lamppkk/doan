        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <?php 
                        $sect2 = Request::segment(2);
                    ?>
                    <li  @if ($sect2 == 'news' || $sect2 == 'gioithieu' || $sect2 == 'dieukhoan' || $sect2 == 'huongdan' || $sect2 == 'chinhsach') class="active" @endif>
                        ...
                        <ul id="noidung" class="collapse">
                            ...
                            <li>
                                <a href="{{ url('admin/gioithieu') }}">Giới thiệu công ty</a>
                            </li>
                            
                            <li>
                                <a href="{{ url('admin/dieukhoan') }}">Điều khoản dịch vụ</a>
                            </li>
                            <li>
                                <a href="{{ url('admin/huongdan') }}">Hướng dẫn mua hàng</a>
                            </li>
                            <li>
                                <a href="{{ url('admin/chinhsach') }}">Chính sánh mua hàng</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li @if(Request::segment(2) =='member') class="active" @endif>
                        <a href="{{ url('admin/member') }}"><i class="fa fa-fw fa-users"></i> Khách hàng</a>
                    </li>
                    ...
                    <li @if(Request::segment(2) =='contact') class="active" @endif>
                        <a href="{{ url('admin/contact') }}"><i class="fa fa-fw fa-reply"></i> Góp ý - Liên hệ </a>
                    </li>
                    
                    <li>
                        <a href="" onclick="return confirm('Chức năng đang được hoàn thiện')"><i class="fa fa-fw fa-bar-chart"></i> Báo cáo - thống kê</a>
                    </li>
                    {{--<li>
