    ...
    <div class="col-lg-4">
        ...
        <div style="margin-top: 25px;"></div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text"  value="{!! old ('txtTen', isset($edit) ? $edit['name'] : null)!!}" onkeyup="ChangeToSlug('txtTen','txtAlias')"  class="form-control" name="txtTen" id="txtTen" placeholder="" required> 
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    ...
                    <span class="input-group-addon">pinstore.vn/</span> 
                    <input value="{!! old ('txtAlias', isset($edit) ? $edit['alias'] : null)!!}" type="text" style="text-align: left; padding: 0" class="form-control input-group-addon" name="txtAlias" value="" id="txtAlias" placeholder="" required> 
                    <span class="input-group-addon">.html</span> </div>
			...
			<div class="form-group">
                ...
                <div class="col-sm-9">
                    <textarea class="form-control" name="txtMota" id="txtMota"  rows="4" required>{!! old ('txtMota', isset($edit) ? $edit['description'] : null)!!}</textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <textarea class="form-control"  name="txtTukhoa" id="txtTukhoa" rows="4" required>{!! old ('txtTukhoa', isset($edit) ? $edit['keyword'] : null)!!}</textarea>
                </div>
            </div>
                ...
                <div class="col-sm-9">
                    <select class="form-control"  name="txtLoaicha" id="txtLoaicha">
						...
						@foreach (GetCat(0) as $item)
							<option value="{{$item['id']}}" @if ($item['id'] == $edit['parent_id']) selected @endif @if ($item['id'] == $edit['id']) disabled @endif >{{$item['name']}}</option>
						@endforeach
            ...
            <div class="form-group" style="margin-left: 50px;">
                <div class="col-sm-offset-2 col-sm-10">
                    <button name="btnThem" id="btnCapnhat" type="submit" class="btn btn-success"><i class="glyphicon glyphicon-ok"></i> <span class="action">Cập nhật </span></button>
                    <a href="{!! URL::route('admin.categorys.getList' )!!}" class="btn btn-warning"><i class="glyphicon glyphicon-repeat"></i> Hủy bỏ</a>
                </div>
            </div>
    </div>
</form>
	...
	<form method="POST" action="{!! route('admin.categorys.postDeleteN') !!}" class="form-horizontal">
        ...
        <div class="table-responsive" style="margin-top: 35px;">
            <table class="table table-bordered table-hover table-striped" cellspacing="0" id="table">
                ...
                <div class="col-lg-3">
                    <select style="margin-left: -15px; width: 115px;" class="form-control input-sm">
                ...
                @foreach ($data as $item)
                    <tr>
                        ...
                        <td>{!! $item['name'] !!}</td>
                        <td>{!! mb_substr($item['description'], 0,50, "utf-8") !!}, ...</td>
                        <td>
                            <?php
                                if($item['parent_id'] > 0) {
