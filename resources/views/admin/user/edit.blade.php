		...
		<div class="col-lg-4">
			<h2>Thêm người dùng</h2>
				<div class="form-group col-sm-12">
					...
					<input disabled value="{!! old ('txtUser', isset($user) ? $user['username'] : null)!!}" type="text"  class="form-control" name="txtUser" id="txtUser" placeholder="" required> 
				</div>
				
				<div class="form-group col-sm-12">
					<label for="txtEmail" class="control-label">Email: </label>
					<input value="{!! old ('txtEmail', isset($user) ? $user['email'] : null)!!}"  type="email"  class="form-control" name="txtEmail" id="txtEmail" placeholder="" required> 
				</div>
