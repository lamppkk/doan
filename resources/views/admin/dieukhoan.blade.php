...
<!-- /.row -->
<form method="POST" action="{!! url('admin/dieukhoan') !!}" enctype="multipart/form-data">
    <input type="hidden" value="{!! csrf_token() !!}" name="_token"/>
    <div class="form-group">
        <label for="txtTieude">Tiêu đề trang: <span class="required">*</span></label>
        <input value="{{ old('txtTieude', getOption('dieukhoan-title')) }}" type="text" class="form-control" name="txtTieude" id="txtTieude" placeholder="" >
    </div>
    <div class="form-group">
        ...
        <textarea required  class="form-control" name="txtNoiDung" id="txtNoiDung" style="width: 400px;" placeholder="">
            {!! old('txtNoiDung', getOption('dieukhoan-content')) !!}
        </textarea>
        <script>
    ...
    <div class="form-group">
        ...
        <textarea required class="form-control" name="txtMota" id="txtMota" rows="4" placeholder="Mô tả ngắn về sản phẩm (Khoảng 200 ký tự)">{!! old('txtMota', getOption('dieukhoan-description')) !!}</textarea>
    </div>

    <div class="form-group">
        <label for="txtTukhoa">Thẻ từ khóa: <span class="required">*</span></label>
        <textarea required class="form-control" name="txtTukhoa" id="txtTukhoa" rows="4" placeholder="Nhập từ khóa">{!! old('txtTukhoa', getOption('dieukhoan-keyword')) !!}</textarea>
    </div>
